...
ScrollTrigger.config({
  ...
  split_paragraph = new SplitText(elements.introContainer.querySelectorAll(".rich-text-two-column p"), { type: "words,lines" });
...
const carousel_duration = carousel_length * 3.8; // adjust speed
